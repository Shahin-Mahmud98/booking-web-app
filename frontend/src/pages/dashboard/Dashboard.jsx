    ...
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            <section className="text-right font-semibold text-gray-500">
              <a href="#" className="text-purple-600 hover:underline"></a> <a href="https://tailwindcss.com/" className="text-teal-400 hover:underline"></a>  <a href="https://dribbble.com/shots/10711741-Free-UI-Kit-for-Figma-Online-Courses-Dashboard" className="text-purple-600 hover:underline"></a> 
            </section>
    </>
  )
}
