...
const Register = () => {
  ...
  return (
    <div className="h-[calc(100vh-120px)] flex justify-center items-center">
     <div className="w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 p-6 pb-8 mb-4">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-4">
          ...
          className="shadow appearance-none border rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow " type="name" name="name" id="name"
     ...
     <div
     className="mt-4">
      <button className="w-full flex flex-wrap gap-1 items-center justify-center bg-slate-700 text-white  hover:bg-blue-700 font-bold py-2 px-4 rounded focus:outline-none">
